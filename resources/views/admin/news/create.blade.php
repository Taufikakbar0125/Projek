        ...
        <div class="col-lg-4">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <select name="status" class="form-select">
                            <option value="pending" {{ old('status') !== 'published' ? 'selected' : '' }}>Pending (draft)</option>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-text">Kosongkan = otomatis saat di-publish</div>
                    </div>
                </div>
            </div>
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="form-text mb-2">JPG/PNG/WebP, maks 2MB</div>
...
// Jika ada old value (setelah validasi gagal), load ke editor
const oldContent = document.getElementById('content-input').value;
if (oldContent) {
    quill.root.innerHTML = oldContent;
}

// Handle submit: sync Quill ke hidden input DULU, baru validasi, baru submit
document.getElementById('news-form').addEventListener('submit', function(e) {
    ...
    // Validasi client-side: jika teks kosong, tampilkan error dan jangan submit
...
// Hilangkan error saat user mulai ketik
