...
<form method="POST" action="{{ route('admin.information.update', $information) }}">
    @csrf @method('PUT')
    ...
    <div class="row g-3 mb-3">
        ...
        <div class="col-md-6">
            ...
            <input type="text" name="slug"
                   ...
                   value="{{ old('slug', $information->slug) }}" required>
            <div class="form-text text-warning"><i class="bi bi-exclamation-triangle-fill"></i> Hati-hati mengubah slug jika sudah dipakai di kode.</div>
    ...
    <div class="row g-3 mb-3">
        <div class="col-md-6">
            ...
            <select name="type" id="type" class="form-select" required>
                <option value="statistik" {{ old('type', $information->type)==='statistik' ? 'selected':'' }}>Teks / Statistik (Angka)</option>
                <option value="agenda"    {{ old('type', $information->type)==='agenda'    ? 'selected':'' }}>Agenda / Event</option>
                <option value="carousel"  {{ old('type', $information->type)==='carousel'  ? 'selected':'' }}>Carousel Slide</option>
                <option value="lainnya"   {{ old('type', $information->type)==='lainnya'   ? 'selected':'' }}>Lainnya</option>
            </select>
        </div>
        <div class="col-md-6">
            ...
            <div class="input-group">
                <input type="text" name="color" id="colorHex"
                       class="form-control"
                       value="{{ old('color', $information->color ?? '#0d6efd') }}"
                       maxlength="20"
                       placeholder="#0d6efd">
    ...
    <div class="row g-3 mb-3">
        <div class="col-md-6">
            ...
            <input type="text" name="value" class="form-control"
                   value="{{ old('value', $information->value) }}"
    ...
    {{-- Event Date --}}
    <div class="mb-3" id="eventDateWrap">
        ...
        <input type="date" name="event_date" class="form-control @error('event_date') is-invalid @enderror"
               value="{{ old('event_date', $information->event_date?->format('Y-m-d')) }}">
    ...
    <div class="mb-4">
        ...
        <textarea name="content" class="form-control" rows="4">{{ old('content', $information->content) }}</textarea>
    </div>
