...
<form method="POST" action="{{ route('admin.users.store') }}">
    ...
    <div class="mb-3">
        ...
        <div class="form-text">
            @if(auth()->user()->isSuperAdmin())
                Super Admin: akses penuh. Admin: kelola konten & setting. Staff: hanya berita & pengumuman.
            @else
                Admin: kelola konten & setting. Staff: hanya berita & pengumuman.
            @endif
        </div>
    ...
    <div class="mb-3">
        ...
        <div class="form-text">Min 8 karakter, harus ada huruf besar, huruf kecil, dan angka.</div>
